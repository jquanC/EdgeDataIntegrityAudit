package com.fchen_group.ESEdgeDataIntegrity.Run;


import com.fchen_group.ESEdgeDataIntegrity.Core.ChallengeData;
import com.fchen_group.ESEdgeDataIntegrity.Core.ESEDIAudit;
import com.fchen_group.ESEdgeDataIntegrity.Core.Key;
import com.fchen_group.ESEdgeDataIntegrity.Core.ProofData;
...
public class Benchmark {
    ...
    private void auditProcess(int ithTest, long[][] sTime, long[][] time) throws IOException {
        ...
        ESEDIAudit fsEDI = new ESEDIAudit(filePath, replicaPath, SECTOR_NUMBER, CHA_LEN);
       ...
       // byte[][][] allSelectBlock = fsEDI.readAllSelectedBlocks(filePath, challengeSet);
        ...
        boolean isDataIntact = fsEDI.Verify(proofData, challengeSet, key);
