package com.fchen_group.ICLEdgeDataIntegrity.Run;


import com.fchen_group.ICLEdgeDataIntegrity.Core.ChallengeData;
import com.fchen_group.ICLEdgeDataIntegrity.Core.ICLEDIAudit;
import com.fchen_group.ICLEdgeDataIntegrity.Core.Key;
import com.fchen_group.ICLEdgeDataIntegrity.Core.ProofData;
...
public class Benchmark {
   ...
   //private static int SECTOR_NUMBER;
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
        ...
        new com.fchen_group.ICLEdgeDataIntegrity.Run.Benchmark().run();
    ...
    private void auditProcess(int ithTest, long[][] sTime, long[][] time) throws IOException, NoSuchAlgorithmException {
        ...
        ICLEDIAudit iclEDI = new ICLEDIAudit(filePath, replicaPath, BLOCK_SIZE, CHA_LEN);
